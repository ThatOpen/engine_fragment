import { BufferGeometry, BufferAttribute as BufferAttribute$1, InstancedMesh, Color as Color$1, Vector3 as Vector3$1, Vector2 as Vector2$1, Plane, Line3, Triangle, Sphere, Matrix4, BackSide, DoubleSide, Box3, FrontSide, Mesh, Ray, Quaternion as Quaternion$1, Interpolant, Loader, LoaderUtils, FileLoader, SpotLight, PointLight, DirectionalLight, MeshBasicMaterial, MeshPhysicalMaterial, sRGBEncoding, TangentSpaceNormalMap, ImageBitmapLoader, TextureLoader, InterleavedBuffer, InterleavedBufferAttribute, LinearFilter, LinearMipmapLinearFilter, RepeatWrapping, PointsMaterial, Material, LineBasicMaterial, MeshStandardMaterial, RGBFormat, PropertyBinding, SkinnedMesh, LineSegments, Line, LineLoop, Points, Group, PerspectiveCamera, MathUtils, OrthographicCamera, InterpolateLinear, AnimationClip, Bone, Object3D, Skeleton, TriangleFanDrawMode, NearestFilter, NearestMipmapNearestFilter, LinearMipmapNearestFilter, NearestMipmapLinearFilter, ClampToEdgeWrapping, MirroredRepeatWrapping, InterpolateDiscrete, Texture, TriangleStripDrawMode, VectorKeyframeTrack, QuaternionKeyframeTrack, NumberKeyframeTrack, MeshLambertMaterial } from 'three';
...
class Fragment$1 {
    ...
    export() {
        const geometry = this.mesh.export();
...
class FragmentLoader {
    ...
    getFragment(geometry, materials, data) {
        ...
        const fragment = new Fragment$1(geometry, materials, items.length);
        if (data.id) {
            fragment.id = data.id;
...
class Fragment {
    ...
    static createFragment(builder, positionOffset, normalOffset, blockIdOffset, groupsOffset, materialsOffset, matricesOffset, idsOffset, idOffset) {
...
export { Exporter, Fragment$1 as Fragment, FragmentLoader, GeometryUtils };
