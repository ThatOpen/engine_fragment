...
class GLTFWriter {
	...
	processBufferView( attribute, componentType, start, count, target ) {
		...
		if ( componentType === WEBGL_CONSTANTS$1.UNSIGNED_BYTE ) {
...
export { Fragment$1 as Fragment, FragmentLoader, GeometryUtils, Serializer };
