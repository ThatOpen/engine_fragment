...
export class Fragments {
  ...
  static getRootAsFragments(
    bb: flatbuffers.ByteBuffer,
    obj?: Fragments,
  ): Fragments {
    return (obj || new Fragments()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsFragments(
    bb: flatbuffers.ByteBuffer,
    obj?: Fragments,
  ): Fragments {
  ...
  static finishSizePrefixedFragmentsBuffer(
    builder: flatbuffers.Builder,
    offset: flatbuffers.Offset,
  ) {
