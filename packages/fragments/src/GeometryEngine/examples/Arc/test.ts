...
const update = () => {
  geometryEngine.getArc(arc.geometry, arcData);
};
...
const [panel] = BUI.Component.create<BUI.PanelSection, any>((_) => {
  return BUI.html`
    <bim-panel style="min-width: 25rem;" id="controls-panel" active label="Arc" class="options-menu">
      ...
      <bim-panel-section label="Controls">
        ...
        <bim-checkbox label="Ending normal to center" value=${false} @change=${(
          e: any,
        ) => {
