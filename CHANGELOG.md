...
## [3.5.0](https://github.com/ThatOpen/engine_fragment/compare/v3.4.0...v3.5.0) (2026-09-25)
...
* **FragmentsModels:** shared IFragmentsModel interface across model types ([#227](https://github.com/ThatOpen/engine_fragment/issues/227)) ([3ccce85](https://github.com/ThatOpen/engine_fragment/commit/3ccce850303ddb72843133d3e04a86b4e19c2098))
...
* **ifc-importer:** include IFC4x3 alignment layouts in the spatial structure ([#743](https://github.com/ThatOpen/engine_fragment/issues/743)) ([c094e73](https://github.com/ThatOpen/engine_fragment/commit/c094e73aa0ef6c1eb67a9f63a7a7bd223f9d8ccd))
...
* add getItemCategory wrapper to the virtual model ([#267](https://github.com/ThatOpen/engine_fragment/issues/267)) ([a95c679](https://github.com/ThatOpen/engine_fragment/commit/a95c679ac26e8529db98dddedde6515e39521b33))
* **alignments:** dispose all alignment geometries and materials instead of throwing ([#235](https://github.com/ThatOpen/engine_fragment/issues/235)) ([22b0bde](https://github.com/ThatOpen/engine_fragment/commit/22b0bdea5c07d1f91d827dabc48c9755979d955a))
* awaitable setup and clean disposal for SingleThreadedFragmentsModel ([#261](https://github.com/ThatOpen/engine_fragment/issues/261), [#262](https://github.com/ThatOpen/engine_fragment/issues/262)) ([2dd1748](https://github.com/ThatOpen/engine_fragment/commit/2dd17489e124d6fe0ee8af2835adba7d3424cc28))
...
* cap the tile cache per worker ([217b9b0](https://github.com/ThatOpen/engine_fragment/commit/217b9b05da7d7e7fb54f01532715a0f441a9f6a8))
* collectDeps no longer reports nonexistent ids ([ae6b024](https://github.com/ThatOpen/engine_fragment/commit/ae6b024d5b64dd2417445204d09af4a31ee8ba43))
* compact tile indices into one draw range per tile ([9db04dd](https://github.com/ThatOpen/engine_fragment/commit/9db04dd66faa0ae42e166e9dc566ba7ef7e12cc5))
...
* depth bias fields on MaterialDefinition to resolve coplanar z-fighting ([#266](https://github.com/ThatOpen/engine_fragment/issues/266)) ([caba371](https://github.com/ThatOpen/engine_fragment/commit/caba371731874e95b00514b4d180a2952072c7b1))
* don't cull geometry before a camera is set ([43b1f9c](https://github.com/ThatOpen/engine_fragment/commit/43b1f9ccbd0fbd2500b00b51a5c0419d6888bc5b)), closes [#255](https://github.com/ThatOpen/engine_fragment/issues/255)
...
* fill tiles sorted by size ([e190daf](https://github.com/ThatOpen/engine_fragment/commit/e190dafc5a62c4d8accebeaaf016937ed0739249))
...
* **FragmentsModels:** transfer Uint8Array model data to the worker instead of cloning it ([#241](https://github.com/ThatOpen/engine_fragment/issues/241)) ([948b385](https://github.com/ThatOpen/engine_fragment/commit/948b385ce8795ae715bc1a8876dfc7ac1e6cc2dc))
* get rid of debug logs ([03cd103](https://github.com/ThatOpen/engine_fragment/commit/03cd10361670d0285040f16b83210967f94b5cba))
* **grid-reader:** make the grid guid optional and normalise a null GlobalId ([c22f68f](https://github.com/ThatOpen/engine_fragment/commit/c22f68fb6bb82bf3a718786db41bcf365373dc4a))
* **grid-reader:** read grid guid ([e565d60](https://github.com/ThatOpen/engine_fragment/commit/e565d6001d9758aec557ae0b9d7b436cfc946c05))
...
* hierarchical frustum culling via the box structure ([2a6d31c](https://github.com/ThatOpen/engine_fragment/commit/2a6d31c38234d8517e2a08594c20aa3e031f7eec))
...
* **ifc-importer:** render IFCBEARING and IFCREFERENT ([#744](https://github.com/ThatOpen/engine_fragment/issues/744)) ([2b171e3](https://github.com/ThatOpen/engine_fragment/commit/2b171e3d94d956d69eb86ff5cbee58d3b51a19f8))
...
* **IfcImporter:** convert grids when a grid axis tag is omitted ([#244](https://github.com/ThatOpen/engine_fragment/issues/244)) ([2131605](https://github.com/ThatOpen/engine_fragment/commit/21316056caf518e977ee6eefe4a75934e38a50fd))
* **IfcImporter:** import material property sets behind includeMaterialProperties ([#249](https://github.com/ThatOpen/engine_fragment/issues/249)) ([e53276f](https://github.com/ThatOpen/engine_fragment/commit/e53276f3d1c1594c785750b1744650c87d42e07d))
* **IfcImporter:** order-sensitive vertex hashing in the geometry dedup key ([dfdd873](https://github.com/ThatOpen/engine_fragment/commit/dfdd8733e69455efccf58ac2ff369c137f7fc1a1))
...
* include property names in rendered material identity ([6242c2b](https://github.com/ThatOpen/engine_fragment/commit/6242c2b6d8c2c204b08dcb3fd5643c5ca6c46f15))
...
* index edit requests for faster property reads ([0ced7f1](https://github.com/ThatOpen/engine_fragment/commit/0ced7f14829e0c0ea02d69d16b1228200fb34d4c))
* index items by category for getItemsOfCategories ([5b8d4f5](https://github.com/ThatOpen/engine_fragment/commit/5b8d4f57724b0276785bf9f6660447d188b65fbb))
...
* keep web-ifc out of the worker bundle ([#289](https://github.com/ThatOpen/engine_fragment/issues/289)) ([2e7b7bd](https://github.com/ThatOpen/engine_fragment/commit/2e7b7bd5d49b08f4adf9c12f92e51dd1e6b6876d))
* **parser:** streaming STEP tokenizer with web-ifc tape parity ([dceedc8](https://github.com/ThatOpen/engine_fragment/commit/dceedc86d3e39cb91faf2da675f2025b143e5833))
...
* reuse identical preserved material definitions ([63bc3e9](https://github.com/ThatOpen/engine_fragment/commit/63bc3e970397efa2832ce7a19535ebe2c72f6f23))
* rotate thread updater across workers ([4ed4d47](https://github.com/ThatOpen/engine_fragment/commit/4ed4d47a8b98b2f7e0e62d7e35a03f503ce4a033))
* setSample passes real visibility to updateTile ([c6a0d2f](https://github.com/ThatOpen/engine_fragment/commit/c6a0d2f0fe49386bfea4549eb3b2ec31f9ceef8e))
* settle update fences when no models remain ([9746997](https://github.com/ThatOpen/engine_fragment/commit/9746997b208fe31e7abe7aa6f54add9627a513d2))
...
* skip delta rebuild on data-only edits ([700b1b1](https://github.com/ThatOpen/engine_fragment/commit/700b1b1f4816e0de1cffb2c1acc6bfa020bc411b))
...
* **split:** configurable IfcSplitter type lists and options ([a16437b](https://github.com/ThatOpen/engine_fragment/commit/a16437bc2249772c1936012852216a6d7b03ad7e))
* **splitter:** environment-agnostic streaming IO for split and extract ([#197](https://github.com/ThatOpen/engine_fragment/issues/197)) ([40db05b](https://github.com/ThatOpen/engine_fragment/commit/40db05bcf3dda9c31e242307e57f3493899d4c0d)), closes [#180](https://github.com/ThatOpen/engine_fragment/issues/180)
* **splitter:** inline fixture conversion and test timeouts ([ec7a7c7](https://github.com/ThatOpen/engine_fragment/commit/ec7a7c79337bda79d6fdf20442ab4eb3f1553b10))
* stamp generator and version into model metadata ([#273](https://github.com/ThatOpen/engine_fragment/issues/273)) ([7da302d](https://github.com/ThatOpen/engine_fragment/commit/7da302df8dc1c7e1a6bdea4ba07f63af1be2495c))
* surface unsupported grid axis curves instead of dropping them ([#264](https://github.com/ThatOpen/engine_fragment/issues/264)) ([d02a8a3](https://github.com/ThatOpen/engine_fragment/commit/d02a8a380dade48663f13cbaae91f31adf5372a7))
* survive grids without ObjectPlacement and report per-grid failures ([#263](https://github.com/ThatOpen/engine_fragment/issues/263)) ([74d0b3e](https://github.com/ThatOpen/engine_fragment/commit/74d0b3ed37784a17994cc4c26ef6613d18466808))
...
* **visibility:** query item visibility in the itemId space ([#750](https://github.com/ThatOpen/engine_fragment/issues/750)) ([ea620e3](https://github.com/ThatOpen/engine_fragment/commit/ea620e3ee3a30fb0fc1ce4d764801e42049a7f04))
...
* **FragmentsModels:** coalesce forced updates inside the rate window instead of bypassing it ([756e3f1](https://github.com/ThatOpen/engine_fragment/commit/756e3f1960560df25be2f7597baa8e9fa64c2212))
* **FragmentsModels:** memoize localId index lookups in properties controller ([#245](https://github.com/ThatOpen/engine_fragment/issues/245)) ([dc8d5b2](https://github.com/ThatOpen/engine_fragment/commit/dc8d5b2e2a6f0f459b6a1ec298610d51285a111a))
* **FragmentsModels:** skip view refresh and re-cull when the view is unchanged ([d5627de](https://github.com/ThatOpen/engine_fragment/commit/d5627dee59e4585682a592d0927a9ad9786f6b38))
* **FragmentsModels:** use Set lookup for itemIds filter in getItemsByAttribute ([#246](https://github.com/ThatOpen/engine_fragment/issues/246)) ([ce1f686](https://github.com/ThatOpen/engine_fragment/commit/ce1f686899002b971513fe33a51da0042e6e25a3))
